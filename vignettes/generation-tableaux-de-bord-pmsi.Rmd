...
dimRactivite:::update_options('~/GH_PMSI/INFORMATIQUE/GIT/remi/tableaux_de_bord/options.yaml')
...
remontees_dispo <- dimRactivite:::analyse_dossier_remontees()
...
```{r load_all}
dimRactivite:::load_RData( sel_remontees_import )
```
