...
dashboardPage(
  ...
  dashboardSidebar(
    ...
    fileInput("courant", "Fichiers du mois à traiter (année N)", multiple = TRUE), 
    fileInput("consol", "Fichiers M12 de l'année précédente (année N-1)", multiple = TRUE),
    fileInput("struct", "Fichier structure", multiple = FALSE),
    checkboxInput("tarifsant", label = "Ajouter le calcul de la valorisation aux tarifs de l'année précédente"),
